...
@Composable
internal fun RegisterTwoPaneContent(
  state: AuthUiState,
  ...
  Row(
    ...
    LazyColumn(
      ...
      item {
        AuthHeader(title = stringResource(id = R.string.destination_auth_register))
      }

      item {
        Text(
          text = stringResource(id = R.string.auth_register_description),
